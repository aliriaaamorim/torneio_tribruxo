export default class PCasa3 extends Phaser.Physics.Matter.Sprite {
    constructor(data,numAleat,nome){
        ...
        if (this.nome == 'player1'){
            this.personagem = this.scene.add.image(30,30,'fcasa3');
            this.personagem.depth=50;
            this.scene.add.text(0,50,'Player 1');
        }
        else if (this.nome == 'player2'){
            this.personagem = this.scene.add.image(770,30,'fcasa3');
            this.personagem.depth=50;
    ...
    static preload(scene){
        scene.load.atlas('casa3','assets/images/casa3/casa3.png','assets/images/casa3/casa3_atlas.json')
        scene.load.animation('casa3_anim','assets/images/casa3/casa3_anim.json');
    }
    ...
    update(){
        ...
        if (this.inputKeys.left.isDown){
            playerVelocity.x = -1;
            this.anims.play('casa3_left',true);
        } else if (this.inputKeys.right.isDown){
            playerVelocity.x = 1;
            this.anims.play('casa3_right',true);
        } 

        if (this.inputKeys.up.isDown){
            playerVelocity.y = -1;
            this.anims.play('casa3_back',true);
        } else if (this.inputKeys.down.isDown){
            playerVelocity.y = 1;
            this.anims.play('casa3_front',true);
        }
